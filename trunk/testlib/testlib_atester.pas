{ This is MOFIFIED VERSION of Testlib. 
  This module should be used for preparing checkers working with ATester. 
  You can use the same functions as in ordinal checkers, but log format will differ.

  Modified by Alexander Agulenko, 23 April 2011

  Check http://code.google.com/p/atester to see current version of ATester and Testlib.
...
(*
    Modifications log:
			...
			23.04.2011  Alexander Agulenko   ATester checker format support
...
//                beep(100, 300);
    ...
    begin
        ...
        rewrite(ResFile);
				...
				{ Standart Testlib writing to report file (code is below) commented. 
					After comments you can see writing to report, used by ATester. }
        ...
        begin
            ...
            writeln(ResFile, '.Check Comments = ', msg);
				...
				if ord(res) = 0 then writeln(ResFile, 'OK') else writeln(ResFile, 'WA');
...
begin
    if mode = _Output then 
				testlib_atester.quit(res, msg)
    else 
        testlib_atester.quit(_fail, msg + ' (' + name + ')');
end;
