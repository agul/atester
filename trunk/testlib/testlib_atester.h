/* 
 * This is MODIFIED VERSION of Testlib.
 * This version deal with ATester (creates correct output files)
 * You can use the same function as in standart version. Only report will differ.
 * 
...
void InStream::quit(TResult result, const char * msg)
{
    ...
    if (resultName != "")
    {
		...
		// commented code below is standart Testlib writing to report
		// code after comments is writing to report, used by ATester
